...
namespace Teste.Migrations
{
    ...
    [Migration("20250926075928_VigesimaSegunda")]
    partial class VigesimaSegunda
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Teste.Models.ActividadeSucursal", b =>
                {
                    ...
                    b.HasKey("SucursalId", "ActividadeId");

                    b.HasIndex("ActividadeId");

                    b.ToTable("ActividadeSucursais");
                });
            ...
            modelBuilder.Entity("Teste.Models.Gestor", b =>
                {
            ...
            modelBuilder.Entity("Teste.Models.Sede", b =>
                {
                    ...
                    b.Property<int?>("AnoEncerramento")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Teste.Models.Sucursal", b =>
                {
                    b.HasBaseType("Teste.Models.Sede");
            ...
            modelBuilder.Entity("Teste.Models.ActividadeSucursal", b =>
                {
                    b.HasOne("Teste.Models.Actividade", "Actividade")
                        .WithMany("ActividadeSucursais")
                        .HasForeignKey("ActividadeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Teste.Models.Sucursal", "Sucursal")
                        .WithMany("Actividades")
            ...
            modelBuilder.Entity("Teste.Models.Sucursal", b =>
                {
                    ...
                    b.HasOne("Teste.Models.Sede", null)
                        .WithOne()
                        .HasForeignKey("Teste.Models.Sucursal", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Teste.Models.Actividade", b =>
                {
                    b.Navigation("ActividadeEmpresas");

                    b.Navigation("ActividadeSucursais");
                });
